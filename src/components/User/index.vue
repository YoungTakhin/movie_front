<template>
    <div id="svg-bg">
        ...
        <nav class="p-2 container text-dark">
            <div class="mt-3">
                <b-pagination class="" limit="9" v-model="currentPage" :total-rows="pageSum" align="center"/>
            </div>
        </nav>
    ...
    export default {
        ...
        data () {
            return {
                ...
                pageSum: 0, // 总页数*20，总页数=电影数/24，向上取整
                currentPage: 1,
        ...
        methods: {
            getMovieCount() {
                this.$axios({
                    ...
                    this.pageSum = Math.ceil(response.data / 24) * 20;
                });
            },
            load() {
                this.loading = true;
                this.$axios({
                    method: "GET",
                    url: "/api/" + this.currentPage + "/movies",
                    headers: {
